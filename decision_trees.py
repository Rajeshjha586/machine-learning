...
correlation = my_data.drop('Drug', axis=1).corr()['Drug_num']
# print(correlation)
...
#bFrom this tree, we can derive the criteria developed by the model to identify
# the class of each training sample. We can interpret them by tracing the criteria
# defined by tracing down from the root to the tree's leaf nodes.
