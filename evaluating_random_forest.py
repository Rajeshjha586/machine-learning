...
# Split the data into training and testing sets (Reserve 20% of the data for evaluation)
...
# Although we saw a small average residual of only -$1400,
# you can see from this plot that the average error as a
# function of median house price is actually increasing from negative to positive values. In other words,
