...
# Standardization of data is important to better define the decision boundaries between
# classes by making sure that the feature variations are in similar scales.
